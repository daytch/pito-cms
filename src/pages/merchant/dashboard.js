                            ...
                            <div className="flex flex-wrap">
                                {
                                    upcomingVideos.map((item, index) => {
                                        ...
                                        return (
                                            <div key={index} className="flex flex-wrap w-full xl:w-1/2 mt-4">
                                                <FullWidth actionLinks="/merchant/dashboard/edit" dataVideos={videos} title={item.title} actions={true} caption={item.description} category={item.categories} socmedCustom={true} />
                                            </div>
                                        )
                                    })
                                }

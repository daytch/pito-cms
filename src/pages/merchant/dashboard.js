                                        ...
                                        liveVideos.map((item, index) => {
                                            ...
                                            return (
                                                <div className="flex flex-wrap w-full xl:w-1/2 mt-4">
                                                    <FullWidth key={index} dataVideos={videos} title={item.title} caption={item.description} category={item.categories} socmedCustom={true} />
                                                </div>
                                            )
                                        })
                                    }
                                ...
                                <div className="flex flex-wrap">
                                    {
                                        upcomingVideos.map((item, index) => {
                                            ...
                                            return (
                                                <div className="flex flex-wrap w-full xl:w-1/2 mt-4">
                                                    <FullWidth key={index} actionLinks="/merchant/dashboard/edit" dataVideos={videos} title={item.title} actions={true} caption={item.description} category={item.categories} socmedCustom={true} />
                                                </div>
                                            )
                                        })
                                    }
                                ...
                                <div className="flex flex-wrap">
                                    {
                                        previousVideos.map((item, index) => {
                                            ...
                                            return (
                                                <div className="flex flex-wrap w-full xl:w-1/2 mt-4">
                                                    <FullWidth key={index} dataVideos={videos} title={item.title} viewsElement={true} actions={false} caption={item.description} category={item.categories} socmedCustom={true} />
                                                </div>
                                            )
                                        })
                                    }
